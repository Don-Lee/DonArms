...
public class AutoCompleteTextAdapter extends BaseAdapter implements Filterable {
  ...
  public AutoCompleteTextAdapter(String[] data, Context context) {
    super();
    this.mData = data;
  ...
  class ReceiverFilter extends Filter {
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
      ...
      if (null != tempList) {
        ...
        // } else {
        mData = tempList.toArray(new String[tempList.size()]);
        // 这个时候输入的关键字
